...
def parse_args():
    ...
    parser.add_argument("--experiments_path", type=str, default="./result_dir/experiments/", help="the path of experiments")
    ##################################### Training setting #################################################
    ...
    parser.add_argument("--alpha", default=0.02, type=float, help="unlearn noise")
